...
class touchscreenEvaluator:
    ...
    def calc_distribution_score(self, noisy_frame, actual_frame, student_frame):
        """
        Scores the accuracy of a frame distribution comparing it to the acutal finger location frame.
        ...
        Inputs:
           ...
           student_frame: The distribution frame created by filter_noisy_data in touchscreenHMM
